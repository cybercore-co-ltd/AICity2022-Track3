...
class ConvTransformerBackbone(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.mulview2single = Mlp(n_in*3, hidden_features=1152, out_features=n_in, drop=0.5)
        assert len(arch) == 3
    ...
    def forward(self, x, mask):
        ...
        # x, mask = self.mulview2single_1(x, mask)
        # x, mask = self.mulview2single_2(x, mask)
        x = self.mulview2single(x)
