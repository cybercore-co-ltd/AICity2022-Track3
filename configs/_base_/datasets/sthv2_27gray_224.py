...
train_pipeline = [
    dict(type='SampleFrames', clip_len=27, frame_interval=2, num_clips=1),
    dict(type='RawFrameDecode'),
    dict(type='Stack3Gray2RGB'),
    ...
    dict(type='Collect', keys=['imgs', 'label'], meta_keys=['num_clips', 'clip_len']),
    dict(type='ToTensor', keys=['imgs', 'label'])
]
val_pipeline = [
    dict(type='SampleFrames', clip_len=27, frame_interval=2, num_clips=1, test_mode=True),
    dict(type='RawFrameDecode'),
    dict(type='Stack3Gray2RGB'),
    dict(type='Resize', scale=(-1, 256)),
